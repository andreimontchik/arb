...
pub const INITIALIZE2_IX_DISCM: [u8; 8] = [9, 203, 254, 64, 89, 32, 179, 159];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub const MONITOR_STEP_IX_DISCM: [u8; 8] = [252, 219, 18, 48, 87, 183, 26, 154];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub fn withdraw_verify_account_keys(
    ...
    for (actual, expected) in [
        ...
        (*accounts.serum_vault_signer.key, keys.serum_vault_signer),
        (*accounts.user_lp_token_account.key, keys.user_lp_token_account),
        (*accounts.uer_coin_token_account.key, keys.uer_coin_token_account),
        (*accounts.uer_pc_token_account.key, keys.uer_pc_token_account),
        (*accounts.user_owner.key, keys.user_owner),
        (*accounts.serum_event_q.key, keys.serum_event_q),
        (*accounts.serum_bids.key, keys.serum_bids),
        (*accounts.serum_asks.key, keys.serum_asks),
...
pub fn withdraw_verify_writable_privileges<'me, 'info>(
    ...
    for should_be_writable in [
        ...
        accounts.serum_pc_vault_account,
        accounts.user_lp_token_account,
        accounts.uer_coin_token_account,
        accounts.uer_pc_token_account,
        accounts.serum_event_q,
        accounts.serum_bids,
        accounts.serum_asks,
    ] {
...
pub const MIGRATE_TO_OPEN_BOOK_IX_DISCM: [u8; 8] = [207, 98, 243, 89, 114, 174, 205, 20];
#[derive(Clone, Debug, PartialEq)]
...
pub const WITHDRAW_PNL_IX_DISCM: [u8; 8] = [86, 36, 158, 158, 92, 241, 251, 94];
#[derive(Clone, Debug, PartialEq)]
...
pub const WITHDRAW_SRM_IX_DISCM: [u8; 8] = [193, 101, 58, 65, 120, 78, 99, 31];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub const SWAP_BASE_IN_IX_DISCM: [u8; 8] = [42, 236, 72, 162, 242, 24, 39, 84];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub fn swap_base_in_verify_account_keys(
    ...
    for (actual, expected) in [
        ...
        (*accounts.serum_pc_vault_account.key, keys.serum_pc_vault_account),
        (*accounts.serum_vault_signer.key, keys.serum_vault_signer),
        (*accounts.uer_source_token_account.key, keys.uer_source_token_account),
        (
...
pub fn swap_base_in_verify_writable_privileges<'me, 'info>(
    ...
    for should_be_writable in [
        ...
        accounts.serum_coin_vault_account,
        accounts.serum_pc_vault_account,
        accounts.uer_source_token_account,
        accounts.uer_destination_token_account,
    ] {
        if !should_be_writable.is_writable {
            return Err((should_be_writable, ProgramError::InvalidAccountData));
        }
...
pub const PRE_INITIALIZE_IX_DISCM: [u8; 8] = [255, 92, 87, 45, 198, 172, 236, 2];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub const SWAP_BASE_OUT_IX_DISCM: [u8; 8] = [163, 210, 155, 208, 175, 146, 213, 150];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub const SIMULATE_INFO_IX_DISCM: [u8; 8] = [195, 75, 104, 72, 253, 176, 183, 160];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub const ADMIN_CANCEL_ORDERS_IX_DISCM: [u8; 8] = [151, 90, 110, 217, 196, 223, 251, 95];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
pub const CREATE_CONFIG_ACCOUNT_IX_DISCM: [u8; 8] = [
    190,
    227,
    122,
    84,
...
pub const UPDATE_CONFIG_ACCOUNT_IX_DISCM: [u8; 8] = [240, 32, 10, 152, 8, 45, 87, 58];
#[derive(BorshDeserialize, BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
