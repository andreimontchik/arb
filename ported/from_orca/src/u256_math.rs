/// The file is ported from the [Orca Whirlpools](https://github.com/orca-so/whirlpools/blob/main/programs/whirlpool/src/math/u256_math.rs repo on 03/01/2024.
...
impl U256Muldiv {
    ...
    pub fn try_into_u128(&self) -> Result<u128, PortedFromOrcaError> {
        if self.num_words() > 2 {
            return Err(PortedFromOrcaError::NumberDownCastError);
        }
...
#[cfg(test)]
mod fuzz_tests {
    use {super::*, crate::bn::U256, proptest::prelude::*};
...
mod test_div {
    ...
    fn test_div_2() {
        ...
        let result2 =
            ((U256::from(50u128) << 128) + U256::from(100u128 << 64)).div_mod(U256::from(100u128 << 64));
