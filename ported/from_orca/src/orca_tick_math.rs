/// The file is ported from the [Orca Whirlpools](https://github.com/orca-so/whirlpools/blob/main/programs/whirlpool/src/math/tick_math.rs repo on 03/01/2024.
/// The Orca Whirlpools source code is failing to compile because it uses incomptatible version of the Borsh serializer.
use {crate::u256_math::*, std::convert::TryInto};
